...
require(__DIR__.'/../inc/brandQuery.php');
require(__DIR__.'/../inc/typeQuery.php');
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              ...
              <li> <a href="#" class="text-muted"><?= $type['name'] ?></a></li>
              <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
            <!-- Le foreach permet de parcourir le tableau (array) $brandList
            On récupére ensuite dans la variable $brand, le tableau associatifs
            Pour chaque ligne de résultat de ma requête -->
            <?php foreach($brandList as $brand) : ?>
              <li> <a href="#" class="text-muted"><?= $brand['name'] ?></a></li>
              <?php endforeach; ?>

              <!-- La traduction de ce que fait le parcours du tableau $brandList avec foreach -->
              <!-- <li> <a href="#" class="text-muted"></?= $brandList[0]['name'] ?></a></li>
              <li> <a href="#" class="text-muted"></?= $brandList[1]['name'] ?></a></li>
              <li> <a href="#" class="text-muted"></?= $brandList[2]['name'] ?></a></li>
              <li> <a href="#" class="text-muted"></?= $brandList[3]['name'] ?></a></li>
              <li> <a href="#" class="text-muted"></?= $brandList[4]['name'] ?></a></li> -->
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 text-center text-md-left">
            <p class="mb-md-0">© 2018 shop. Tous droits réservés.</p>
          </div>
          <div class="col-md-6">
